...
class CardDeliveryTest {
    ...
    void shouldSuccessfulPlanMeeting() {
        ...
        String firstMeetingDate = String.valueOf(DataGenerator.generateDate(daysToAddForFirstMeeting));


        int daysToAddForSecondMeeting = 7;
        String secondMeetingDate = String.valueOf(DataGenerator.generateDate(daysToAddForSecondMeeting));
